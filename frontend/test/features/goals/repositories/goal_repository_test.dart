...
void main() {
  ...
  group('GoalRepository.addGoal', () {
    test(
      'issues POST /goals and returns parsed Goal (no account links)',
      () async {
        adapter.enqueue(
          201,
          _goalJson(
    ...
    test(
      'links accounts after creating goal when accountIds provided',
      () async {
  ...
  group('GoalRepository.getRecentAllocationSummary', () {
    test(
      'issues GET /allocations/summary and returns totalSavings/totalPurchases',
      () async {
